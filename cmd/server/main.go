...
func newUazapiFromEnv() *uazapi.Client {
    ...
    // A Uazapi recomenda enviar o corpo completo com campos como
    // readchat/linkPreview para ativar o indicador de "digitando...".  Por
    // padrão, preferimos desativar o payload mínimo para garantir o
    // comportamento consistente do provedor.  O valor ainda pode ser
    // sobrescrito via variável de ambiente UAZAPI_MINIMAL_PAYLOAD.
    minimalPayload := getenvBool("UAZAPI_MINIMAL_PAYLOAD", false)
