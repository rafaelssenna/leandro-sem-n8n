...
// webhookPayload models the incoming JSON from Uazapi. Only fields used in this
// service are included.
type webhookPayload struct {
    Body struct {
        Message struct {
            MessageType    string `json:"messageType"` // ExtendedTextMessage | Conversation | AudioMessage | ImageMessage | DocumentMessage ...
...
func (h *webhookHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
    ...
    if msgType == "audio" {
        ...
        // Save assistant message record as audio
        _ = models.InsertMessage(ctx, h.pool, models.Message{
        ...
        // Save assistant message as text
        _ = models.InsertMessage(ctx, h.pool, models.Message{
